...
- 当$f_{xx}(x_0,y_0)\cdot f_{yy}(x_0,y_0)>f_{xy}(x_0,y_0)$时有极值，且当
	-  $f_{xx}(x_0,y_0)>0$时有极小值
	- $f_{xx}(x_0,y_0)<0$时有极大值
- 当$f_{xx}(x_0,y_0)\cdot f_{yy}(x_0,y_0)=f_{xy}(x_0,y_0)$无法判断是否有极值
- 当$f_{xx}(x_0,y_0)\cdot f_{yy}(x_0,y_0)<f_{xy}(x_0,y_0)$时无极值
